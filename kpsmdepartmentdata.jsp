...
<html>
<head>
    <title>KPSM Department Data</title>
    <div class="header">
            ...
            <%
                ...
                try {
                    ...
                    String query = "SELECT r.firstName, r.lastName, r.workposition, r.email, r.phoneNumber, r.branch, " +
                            ...
                            "WHERE r.department = 'KPSM' OR r.department = 'Khidmat Pengurusan dan Sumber Manusia' " +
                    ...
                    while (rs.next()) {
                        ...
                        // Determine group based on work position
                        String group = "";
                        switch (workposition) {
                            case "WK54":
                            case "WK52":
