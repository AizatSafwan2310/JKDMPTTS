...
<body>
 ...
 <div class="sidebar">
    ...
    <button class="nav-button" onclick="location.href='summary.jsp'">REPORT & SUMMARY</button>
    <button class="nav-button" onclick="location.href='JKDMLogout.jsp'">LOG OUT</button>
  </div>
    ...
    <div class="container">
        ...
        <!-- User-specific dashboard content can go here -->
