    ...
    <%
        ...
        if (currentSession != null) {
            ...
            if (firstName != null && icnumber != null) {
                // Display course update form specific to the user
                out.print("<form action='submitCourseUpdate.jsp' method='post'>");
                out.print("Course Name: <input type='text' name='courseName'><br>");
                out.print("Credit Hours: <input type='text' name='creditHours'><br>");
                out.print("Start Date: <input type='date' name='startDate'><br>");
                out.print("End Date: <input type='date' name='endDate'><br>");
                out.print("Location: <input type='text' name='location'><br>");
                out.print("<input type='hidden' name='firstName' value='" + firstName + "'>");
                out.print("<input type='hidden' name='icnumber' value='" + icnumber + "'>");
